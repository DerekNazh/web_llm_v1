...
from exceptions.excepts import CookiesExpiredError
...
def get_from_llm(task_params):
    ...
    try:
        ...
        response = requests.post(
            f"https://yuanbao.tencent.com/api/chat/35a4f91b-512a-46e6-a26f-c388db3d3404",
            headers=headers,
            cookies=cookies,
...
if __name__ == '__main__':
    task_params = {
        'platform': 'yuanbao',  # 所属平台 #本地部署写poxiao或不写
        'module': 'hunyuan',
